...
import { ArrowRight, Youtube, Music, Instagram, Send } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="card-hover group text-center">
            <div className="bg-red-600/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-red-600 transition-colors duration-300">
            ...
            <div className="text-2xl font-bold text-primary mb-2">23K</div>
            <div className="text-sm text-muted-foreground">Subscribers</div>
          </div>

          {/* Spotify */}
          <div className="card-hover group text-center">
            <div className="bg-green-600/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-green-600 transition-colors duration-300">
              <Music className="w-8 h-8 text-green-600 group-hover:text-white transition-colors duration-300" />
            </div>
          ...
          {/* Instagram */}
          <div className="card-hover group text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          {/* TikTok */}
          <div className="card-hover group text-center">
            <div className="bg-black w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-primary transition-colors duration-300">
        ...
        <div className="card-hover max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Get notified when new episodes drop, plus exclusive behind-the-scenes content and early access to special episodes.
          </p>
