      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm">
            <a href="https://www.youtube.com/@OutmindPod" className="text-muted-foreground hover:text-primary transition-colors">
              All Episodes
            </a>
            <a href="https://www.youtube.com/@OutmindPod" className="text-muted-foreground hover:text-primary transition-colors">
              About
            </a>
            <a href="https://www.instagram.com/outmindpod/" className="text-muted-foreground hover:text-primary transition-colors">
              Contact
            </a>
          </div>
          ...
          <div className="flex gap-4 mb-8">
            ...
            <a 
              href="https://www.tiktok.com/@outmindpod"
              className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all duration-300"
              aria-label="TikTok"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
